...
$packageArgs = @{
  ...
  fileType      = 'exe'
  url64bit      = 'https://github.com/Sigil-Ebook/Sigil/releases/download/2.2.0/Sigil-2.2.0-Windows-x64-Setup.exe'
	
  softwareName  = 'sigil'

  checksum64    = '04befe38b9e923d1a1578027392cdb34968b473efdf5105a553ee84c354c9607'
